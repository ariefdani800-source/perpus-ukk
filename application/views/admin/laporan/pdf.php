...
<body>
    ...
    <div id="loading" class="loading-screen">
        <div>Memproses PDF, mohon tunggu...</div>
    </div>

    <!-- The content we want to export to PDF -->
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            var opt = {
                margin:       [10, 10, 10, 10],
                filename:     'Laporan_Transaksi_Perpustakaan.pdf',
            ...
            html2pdf().set(opt).from(element).save().then(function() {
                document.getElementById('loading').innerHTML = '<div>PDF berhasil didownload.<br><button onclick="window.close()" style="margin-top:20px; padding:10px 20px; cursor:pointer;">Tutup Halaman</button></div>';
            });
        });
    </script>
</body>
