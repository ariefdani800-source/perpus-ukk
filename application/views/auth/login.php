...
<body>
    ...
    <div class="card-login">
        <div class="logo">
            <img src="<?= base_url('assets/img/logo_mbg.png') ?>" alt="Logo Perpustakaan" style="width: 120px; height: auto; border-radius: 24px; margin-bottom: 15px; box-shadow: 0 10px 25px rgba(0,0,0,0.3);">
            <h2>Perpustakaan </h2>
